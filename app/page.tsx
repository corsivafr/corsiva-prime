...
export const metadata: Metadata = {
  ...
  description: 'Import de véhicules premium depuis l’Allemagne et immatriculation en société européenne : sourcing, contrôle, transport, fiscalité, carte grise. Le vrai prix allemand, sans malus ni TVA à supporter. Groupe Corsiva.',
...
const jsonLd = {
  ...
  '@graph': [
    ...
    {
      '@type': 'Service',
      name: 'Import de véhicule depuis l’Allemagne',
      provider: { '@id': `${SITE.url}#org` },
      description: 'Sourcing, inspection, négociation, transport fermé et carte grise. Livraison en France en 3 à 4 semaines.',
      url: `${SITE.url}/import`,
    },
    {
      '@type': 'Service',
      name: 'Immatriculation en société européenne',
      provider: { '@id': `${SITE.url}#org` },
      description: 'Société de location porteuse structurée avec avocat partenaire : malus et TVA non supportés, véhicule circulant dans toute l’Union européenne.',
      url: `${SITE.url}/immatriculation`,
    },
    {
      '@type': 'FAQPage',
