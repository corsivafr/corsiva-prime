  ...
  return (
    <Section tone="light-3" id="simulateur">
      <Wrap>
        ...
        {!full && <Reveal className="rise -mt-8 mb-10 text-center"><Link href="/simulateur" className="inline-flex items-center gap-2 text-[14px] font-medium" style={{ color: 'var(--blue-deep)' }}>Lire la règle de calcul complète <Arrow /></Link></Reveal>}
