...
export type Article = {
  ...
  related?: string[]
  /** Fiche du véhicule en couverture (photo Corsiva) : la couverture renvoie vers cette fiche du catalogue. */
  fiche: string
  /** Fiches proposées en bas d'article (sinon : la fiche de couverture puis l'ordre du catalogue). */
  fiches?: string[]
}
...
const BASE: Article[] = [
  {
    ...
    date: '2026-09-21',
    updated: '2026-09-21',
    cover: '/media/articles/eviter-malus-ecologique-2026.jpg',
    coverAlt: 'BMW M4 blanche de trois quarts avant, plaque Corsiva',
    fiche: 'bmw-m4-competition',
    minutes: 7,
  ...
  },
  {
    ...
    date: '2026-09-21',
    updated: '2026-09-21',
    cover: '/media/articles/importer-voiture-luxe-allemagne-guide.jpg',
    coverAlt: 'Mercedes-AMG CLE 53 Coupé grise de trois quarts avant, plaque Corsiva',
    fiche: 'mercedes-amg-cle-53',
    minutes: 8,
  ...
  },
  {
    ...
    date: '2026-09-21',
    updated: '2026-09-21',
    cover: '/media/articles/immatriculation-etranger-societe-europeenne.jpg',
    coverAlt: 'Audi RS6 Avant grise de trois quarts avant, plaque Corsiva',
    fiche: 'audi-rs6-avant-performance',
    minutes: 6,
  ...
  },
  {
    ...
    date: '2026-09-21',
    updated: '2026-09-21',
    cover: '/media/articles/prix-france-allemagne-m3-classe-g-911.jpg',
    coverAlt: 'Mercedes Classe G grise du groupe Corsiva, plaque Corsiva',
    fiche: 'mercedes-amg-g-63',
    fiches: ['bmw-m3-competition', 'mercedes-amg-g-63', 'porsche-911-carrera-s'],
    minutes: 6,
...
const TETE: Article[] = [
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/bareme-malus-2026-complet.jpg',
    coverAlt: 'Audi R8 blanche de trois quarts avant, plaque Corsiva',
    fiche: 'audi-r8-v10-performance',
    minutes: 8,
  ...
  },
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/voitures-malus-maximal-2026-classement.jpg',
    coverAlt: 'Audi RS Q8 noire de trois quarts arrière, plaque Corsiva',
    fiche: 'audi-rs-q8-performance',
    fiches: ['lamborghini-urus-s', 'mercedes-amg-g-63', 'audi-rs-q8-performance'],
    minutes: 9,
  ...
  },
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/acheter-lamborghini-urus-import-malus.jpg',
    coverAlt: 'Lamborghini Urus jaune de trois quarts avant, plaque Corsiva',
    fiche: 'lamborghini-urus-s',
    fiches: ['lamborghini-urus-s', 'audi-rs-q8-performance', 'mercedes-amg-g-63'],
    minutes: 8,
...
const QUEUE: Article[] = [
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/revendre-voiture-importee-allemagne.jpg',
    coverAlt: 'Porsche 911 Carrera S grise de trois quarts arrière, plaque Corsiva',
    fiche: 'porsche-911-carrera-s',
    minutes: 6,
  ...
  },
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/import-voiture-luxe-paris.jpg',
    coverAlt: 'Audi R8 blanche de trois quarts arrière, plaque Corsiva',
    fiche: 'audi-r8-v10-performance',
    minutes: 6,
  ...
  },
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/import-voiture-luxe-lyon.jpg',
    coverAlt: 'Audi RS Q8 noire de trois quarts avant, plaque Corsiva',
    fiche: 'audi-rs-q8-performance',
    minutes: 6,
  ...
  },
  {
    ...
    date: '2026-09-22',
    updated: '2026-09-22',
    cover: '/media/articles/import-voiture-luxe-annecy-chambery.jpg',
    coverAlt: 'Lamborghini Urus jaune de trois quarts arrière, plaque Corsiva',
    fiche: 'lamborghini-urus-s',
    minutes: 6,
