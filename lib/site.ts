...
export const FAQ = [
  ...
  { q: 'Comment êtes-vous rémunérés ?', a: 'Par un forfait global de 21 000 € pour l’import avec immatriculation européenne, hors prix du véhicule : structuration, exécution et livraison incluses, arrêté à la signature, sans frais additionnel en cours de dossier. L’import seul fait l’objet d’une proposition personnalisée.' },
